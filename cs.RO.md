...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [EVIT: Event-based Visual-Inertial Tracking in Semi-Dense Maps Using Windowed Nonlinear Optimization](https://arxiv.org/abs/2408.01370) | 本文提出了一种结合事件和惯性传感器数据的多模态跟踪方法，通过使用基于窗口的非线性优化算法，实现了在动态和照明条件变化下的精确事件相机自我运动估计，增强了跟踪器的性能。 |
| [^2] | [A Backbone for Long-Horizon Robot Task Understanding](https://arxiv.org/abs/2408.01334) | 该研究提出了一种基于Therblig的框架，通过将高级机器人任务分解为基本配置，并结合基础模型，提高了机器人任务的理解和泛化能力。 |
| [^3] | [Incorporating Control Inputs in the Estimation of Continuous Mobile Robot Trajectories and Continuum Robot Shapes](https://arxiv.org/abs/2408.01333) | 该论文提出了一种结合控制输入的连续高斯过程状态估计框架，适用于移动机器人和连续机器人形状的轨迹估算，能够在减少测量和估计节点的情况下，提供更准确的估计。 |
| [^4] | [HeteroMorpheus: Universal Control Based on Morphological Heterogeneity Modeling](https://arxiv.org/abs/2408.01230) | 本文介绍了一种名为HeteroMorpheus的新方法，该方法在异构图Transformer的帮助下，针对机器人肢体的功能多样性进行了有效建模，显著提高了机器人通用控制策略的泛化能力。 |
| [^5] | [From Problem to Solution: Bio-inspired 3D Printing for Bonding Soft and Rigid Materials via Underextrusions](https://arxiv.org/abs/2408.01210) | 本文介绍了一种使用几乎所有标准FDM打印机的新型3D打印技术，通过利用欠挤这一常见问题，成功地实现了软硬材料之间的可靠粘合，解决了软硬材料粘合难的问题。 |
| [^6] | [IG-SLAM: Instant Gaussian SLAM](https://arxiv.org/abs/2408.01126) | IG-SLAM是一种仅使用RGB的密集SLAM系统，它结合了健壮的密集SLAM跟踪方法和高斯斑点技术，以构建环境的三维地图。通过准确的姿态和密集深度，系统能够优化地图，并采用有效的衰减策略来提高收敛性和运行速度。 |
| [^7] | [Structure from Motion-based Motion Estimation and 3D Reconstruction of Unknown Shaped Space Debris](https://arxiv.org/abs/2408.01035) | 本研究提出了一种基于运动结构的算法，能够利用有限的资源和对未知形状的空间碎片进行运动估计，并同时输出物体的不明形状和相关摄像机的相对姿态轨迹，这些信息用于精确估计目标的运动状态。 |
| [^8] | [The Harmonic Exponential Filter for Nonparametric Estimation on Motion Groups](https://arxiv.org/abs/2408.00907) | 本文提出了一种新的非参数贝叶斯滤波方法，用于处理多模态分布，通过结合调和指数分布的特点，该方法能够有效地代表复杂分布，并在理论和实验上均表现出良好的性能，尤其是在处理多峰分布时。 |
| [^9] | [Real-time Dexterous Telemanipulation with an End-Effect-Oriented Learning-based Approach](https://arxiv.org/abs/2408.00853) | 我不是机器人。 |
| [^10] | [Occupation-aware planning method for robotic monitoring missions in dynamic environments](https://arxiv.org/abs/2408.00846) | 本文介绍了一种名为$MADA$的全局规划器，旨在提高在动态环境中进行监控任务时机器人的部署效率。该规划器考虑了潜在障碍物位置的不确定性以及与其他监控任务的协同，在模拟和实际环境中均优于现有方法，提高了成功完成监控任务的概率。 |
| [^11] | [MSMA: Multi-agent Trajectory Prediction in Connected and Autonomous Vehicle Environment with Multi-source Data Integration](https://arxiv.org/abs/2407.21310) | 该研究提出了一种名为MSMA的深度学习框架，用于综合多源数据以预测复杂交通中的车辆轨迹，特别关注互联自动驾驶车辆（CAV）周围环境，包括自动驾驶车辆（AVs）、互联车辆（CVs）和人类驾驶车辆（HDVs）。 |
| [^12] | ["A Good Bot Always Knows Its Limitations": Assessing Autonomous System Decision-making Competencies through Factorized Machine Self-confidence](https://arxiv.org/abs/2407.19631) | 通过创建自评估系统能力的新框架，科学家们寻求提高自主系统的决策透明度和可靠性。 |
| [^13] | [L-PR: Exploiting LiDAR Fiducial Marker for Unordered Low Overlap Multiview Point Cloud Registration](https://arxiv.org/abs/2406.03298) | 这篇论文提出了一个名为 L-PR 的框架，该框架利用激光雷达 fiducial标记对多视图点云进行注册，并解决了低重叠情况下的注册问题。 |
| [^14] | [DASA: Delay-Adaptive Multi-Agent Stochastic Approximation](https://arxiv.org/abs/2403.17247) | DASA算法是针对多代理随机逼近问题设计的，能够在处理延迟和异步通信的延迟环境中实现快速收敛。 |
| [^15] | [Automated System-level Testing of Unmanned Aerial Systems](https://arxiv.org/abs/2403.15857) | 该论文提出了一种基于模型的测试和人工智能技术的自动化系统级测试方法，为无人航空系统的有效测试提供了可行的解决方案，提高了测试效率和准确性。 |
| [^16] | [Temporal Transfer Learning for Traffic Optimization with Coarse-grained Advisory Autonomy](https://arxiv.org/abs/2312.09436) | 本文提出了一种时间转移学习方法，用来提高咨询自治下的交通效率。这种方法通过在特定的车流量和速度条件下训练策略，然后将其应用于实际交通场景，即使在缺乏完全自动驾驶车辆的情况下，也能有效提高交通流量的通过率并减少事故发生率。 |
| [^17] | [Applications of Spiking Neural Networks in Visual Place Recognition](https://arxiv.org/abs/2311.13186) | 我们的研究提出了模块化脉冲神经网络在视觉位置识别中的应用，包括紧凑的SNN模块、多个代表相同地点的SNN组合，以及对连续图像序列匹配技术的研究，这些技术为机器人视觉系统的精确和低功率视觉位置识别提供了新的框架。 |

# 详细

[^1]: EVIT: 基于事件的事件-惯性半密集地图跟踪方法使用窗限非线性优化
...
[^4]: 异构魔方斯：基于形态异质性建模的通用控制

    HeteroMorpheus: Universal Control Based on Morphological Heterogeneity Modeling

    [https://arxiv.org/abs/2408.01230](https://arxiv.org/abs/2408.01230)
...
[^8]: 非参数估计在运动组上的调和指数滤波器

    The Harmonic Exponential Filter for Nonparametric Estimation on Motion Groups

    [https://arxiv.org/abs/2408.00907](https://arxiv.org/abs/2408.00907)
...
[^9]: 实时灵巧遥操作方法：基于端效导向的机器学习 approach

    Real-time Dexterous Telemanipulation with an End-Effect-Oriented Learning-based Approach

    [https://arxiv.org/abs/2408.00853](https://arxiv.org/abs/2408.00853)
...
[^11]: MSMA：综合多源数据集的多智能体轨迹预测方法在互联自动驾驶车辆环境中的应用
    ...
    [https://arxiv.org/abs/2407.21310](https://arxiv.org/abs/2407.21310)
...
[^12]: "一个好的机器人总是知道其局限性": 通过因子化的自我自信量度评估自主系统的决策能力
...
[^13]: L-PR: 利用激光雷达 fiducial标记进行点云注册的论文标题
